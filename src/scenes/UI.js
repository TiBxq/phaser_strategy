    ...
    create() {
        ...
        GameEvents.on(EventNames.VILLAGER_ASSIGN_REQUEST, ({ buildingUid, count }) => {
            ...
            if (building?.configId === 'BARRACKS') {
                // Barracks: costs 1 weapon per warrior, then dispatch a villager to march there
            ...
            // All buildings: dispatch a free villager to march to the building
        ...
        GameEvents.on(EventNames.VILLAGER_UNASSIGN_REQUEST, ({ buildingUid, count }) => {
            // All buildings: recall stationed/marching entity, then unassign
        ...
        GameEvents.on(EventNames.BANDIT_CAMP_ATTACK_REQUEST, () => {
            ...
            gameScene.combatSystem.startAssault();
        });
